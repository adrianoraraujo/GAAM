...
public class LoadTables {
	...
	public void creatScherma(Connection c) throws SQLException {
		...
		stmt.execute("CREATE TABLE INTEGRANTES ( ID INTEGER IDENTITY PRIMARY KEY,  IDENTIFICACAO VARCHAR(255),"
				+ " ANDAR  VARCHAR(255), FUNCAO VARCHAR(255), BLOCO_ID INTEGER, TIPO_ID INTEGER );");
		stmt.execute("CREATE TABLE TIPOINTEGRANTES ( ID INTEGER IDENTITY PRIMARY KEY,  NOME VARCHAR(255),"
